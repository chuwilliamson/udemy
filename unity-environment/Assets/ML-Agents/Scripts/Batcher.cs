    ...
    public class Batcher
    {
        ...
        public void SubscribeBrain(string brainKey)
        {
            ...
            m_currentUnityRLOutput.AgentInfos.Add(
                brainKey,
                new UnityRLOutput.Types.ListAgentInfoProto());
        }
        ...
        public static BrainParametersProto BrainParametersConvertor(
            BrainParameters brainParameters, string name, BrainTypeProto type)
        {
            ...
            var brainParametersProto = new BrainParametersProto
                {
                    ...
                    (SpaceTypeProto)brainParameters.vectorActionSpaceType,
                    VectorObservationSpaceType =
                    (SpaceTypeProto)brainParameters.vectorObservationSpaceType,
                    BrainName = name,
                    BrainType = type
                };
